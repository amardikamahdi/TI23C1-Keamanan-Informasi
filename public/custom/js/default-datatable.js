var initDatatable = function (table, datatablesUrl, datatablesColumns, options) {
    dt = table.DataTable({
        language: {
...
var initDatatableSearch = function (table, searchInput) {
    table.DataTable().search(searchInput).draw();
}
